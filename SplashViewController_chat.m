...
#import "SplashViewController_chat.h"

#define demoUserLogin @"puneetpal"
#define demoUserPassword @"puneet271"

@interface SplashViewController_chat () <QBActionStatusDelegate>

@end

@implementation SplashViewController_chat
