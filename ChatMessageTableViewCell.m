...
+ (void)initialize{
    ...
    [messageDateFormatter setTimeZone:[NSTimeZone localTimeZone]];
...
//    NSLog(@"message: %@", message);
    ...
    NSLog(@"%lu",(unsigned long)message.senderID);
    ...
    if ([LocalStorageService shared].currentUser.ID == message.senderID) {
        ...
        self.dateLabel.text = [NSString stringWithFormat:@"%@, %@", [kappDelegate uSerName], time];
        ...
        self.dateLabel.textColor = [UIColor whiteColor];
        self.dateLabel.text = [NSString stringWithFormat:@"%@, %@", [kappDelegate CallerName], time];
